...
flags.DEFINE_string(
    "env_dir", "output",#"../../moca/data/motif/eval_envs_motif",
...
def make_sag(app):
    ...
    for trace in all_traces:
        trace_id = trace.split('/')[6]
        # import pdb;pdb.set_trace()
        try:
            with open('../data/processed_motif_deduped/' + trace_id + '.json') as f:
...
if __name__ == "__main__":
    # a=get_uid("/home/wenhao/Desktop/RPA/MoTIF/task_automation/seq2act/data/motif/raw/traces_02_14_21/aplicacion.tiempo/1cf1f0e1-5007-4df4-9d25-1941c046ecff/view_hierarchies/de5e6e01-6b82-4221-b74f-1137c6375d10_149_1612307708010.jpg",
    #                           1440, 2960)
    # print(a)
    main()
