...
def _build_clickable(element, tree_child_as_clickable=True):
  ...
  for node in element.iterancestors():
    ...
    if node.get('clickable') == 'true' or node.get('clickable') == 'True': #or node.get('checkable').lower() == 'true':
      clickable = 'true'
      break
  ...
  if element.get('checkable') == 'true' or element.get('checkable') == 'True':
    clickable = 'true'
  if tree_child_as_clickable:
    ...
    while p is not None:
      ...
      # if p.get('clickable') == 'True':# and p.get('enabled') == 'True':
        clickable = 'true'
        # print(p.get('class'), p.get('text'), p.get('content_desc'))
        break
      p = p.getparent()
      ancestor_id += 1
  # if 'Button' not in element.get('ancestors'):
  #   print(element.get('ancestors'))
  #   import pdb;pdb.set_trace()
  #   clickable = 'false'
...
def _build_etree_from_json(root, json_dict):
  ...
  content_desc = json_dict.get('content-desc', '')
  root.set('content-desc',content_desc)
  root.set('text-hint', json_dict.get('text-hint', ''))
  json_dict.get('content-desc', '')
# print(content_desc)
  # root.set(
  #     'content-desc',
...
class LeafNode(object):
  ...
  def __init__(self,
    ...
    self.uiobject = UIObject(
        ...
        text_hint=element.get('text-hint')
        )
